...
import { FaCheck, FaTrash } from "react-icons/fa"; // FontAwesome Check icon
...
const Products = () => {
    ...
    ${item.rtoStatus === "Free" ? "bg-green-500" :
                                    ...
                                    <td className="p-2 px-5 whitespace-nowrap text-[#8F9BBA]"><div className="flex gap-3"><span><MdModeEdit /></span> <span><FaTrash /></span></div></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
